...
df_impute_mice <- read.csv('C:/Users/GL63/OneDrive - Asia Pacific University/6. Applied Machine Learning/Lab/Lab 3/aug_train_mice.csv', header = T, na.strings=c("NA","NaN", ""), stringsAsFactors=T)
```
...
df_mF <- read.csv('C:/Users/GL63/OneDrive - Asia Pacific University/6. Applied Machine Learning/Lab/Lab 3/aug_train_mF.csv', header = T, na.strings=c("NA","NaN", ""), stringsAsFactors=T)
```
