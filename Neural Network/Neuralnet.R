# neuralnet documentation - https://www.rdocumentation.org/packages/neuralnet/versions/1.44.2/topics/neuralnet

# For additional learning - Example: http://www.learnbymarketing.com/tutorials/neural-networks-in-r-tutorial/
...
# Normalization is a compulsory. If target variable is a factor, it is not normalised.
...
# Neural Networks
# rpprop is a type of backwoard propagation algorithm
# ce- cross entropy is an error function for logical regression

set.seed(333)
# ce - cross entropy
n <- neuralnet(V11~V2+V3+V4+V5+V6+V8+V9+V10, data = training_set, hidden = c(4,3), 
               err.fct = "ce",algorithm = "rprop+",linear.output = FALSE,stepmax = 100000)
...
# Include ROC, AUC and other evaluation metrics
